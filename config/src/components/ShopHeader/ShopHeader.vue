<template>
  <div class="shop-header">
    <nav class="shop-nav" :style="{backgroundImage:`url(${info.bgImg})`}">
      <a class="back">
        <router-link class="iconfont icon-arrow_left" to="/msite"></router-link>
      </a>
    </nav>
    ...
    <div class="shop-content">
      ...
      <div class="header-content">
        <h2 class="content-title" @click="toggleShopWin">
    ...
    <div class="shop-header-discounts" @click="toggleDiscountWin" v-if="info.supports">
    ...
    <transition name="fade">
      <div class="shop-brief-modal" v-show="shopWin">
        ...
        <span class="content-tag">
          ...
          <div class="mask-footer">
            <span class="iconfont icon-close" @click="toggleShopWin"></span>
          </div>
        </div>
    ...
    <transition name="fade">
      <div class="activity-sheet" v-show="discountWin" >
        <div class="activity-sheet-content">
          <h2 class="activity-sheet-title">优惠活动</h2>
          <ul class="list">
            <li class="activity-item"
                :class="tagShow(support.type)"
          ...
          <div class="activity-sheet-close" @click="toggleDiscountWin">
...
<script>
  ...
  export default {
    ...
    methods:{
      toggleShopWin(){
        this.shopWin = !this.shopWin
      },
      toggleDiscountWin(){
        this.discountWin = !this.discountWin
      },
      tagShow: function(type){
        switch (type){
          case 0:
